...
/**
 * @ngdoc object
 * @name lbServices.ExampleModel
 * @object
 *
 * @description
 *
 * A $resource object for interacting with the `ExampleModel` model.
 *
 * ## Example
 *
 * See
...
module.factory(
  ...
  ['LoopBackResource', 'LoopBackAuth', function(Resource, LoopBackAuth) {
    return Resource(
      urlBase + "/exampleModels/:id",
      { 'id': '@id' },
      {
        /**
         * @ngdoc method
         * @name lbServices.ExampleModel#create
         * @methodOf lbServices.ExampleModel
         *
         * @description
         *
         * Create a new instance of the model and persist it into the data source
         ...
         * <em>
         * (The remote method definition does not provide any description.
         * This usually means the response is a `ExampleModel` object.)
         * </em>
         */
        "create": {
          url: urlBase + "/exampleModels",
          method: "POST",
        },
        /**
         * @ngdoc method
         * @name lbServices.ExampleModel#updateOrCreate
         * @methodOf lbServices.ExampleModel
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.ExampleModel#upsert
         * @methodOf lbServices.ExampleModel
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.ExampleModel#exists
         * @methodOf lbServices.ExampleModel
         *
         * @description
         *
         ...
         */
        "exists": {
          url: urlBase + "/exampleModels/:id/exists",
          method: "GET",
        },
        /**
         * @ngdoc method
         * @name lbServices.ExampleModel#findById
         * @methodOf lbServices.ExampleModel
         *
         * @description
         *
         ...
         */
        "findById": {
          url: urlBase + "/exampleModels/:id",
          method: "GET",
        },
        /**
         * @ngdoc method
         * @name lbServices.ExampleModel#find
         * @methodOf lbServices.ExampleModel
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.ExampleModel#findOne
         * @methodOf lbServices.ExampleModel
         *
         * @description
         *
         ...
         */
        "findOne": {
          url: urlBase + "/exampleModels/findOne",
          method: "GET",
        },
        /**
         * @ngdoc method
         * @name lbServices.ExampleModel#destroyById
         * @methodOf lbServices.ExampleModel
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.ExampleModel#deleteById
         * @methodOf lbServices.ExampleModel
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.ExampleModel#removeById
         * @methodOf lbServices.ExampleModel
         *
         * @description
         *
        ...
        /**
         * @ngdoc method
         * @name lbServices.ExampleModel#count
         * @methodOf lbServices.ExampleModel
         *
         * @description
         *
         ...
         */
        "count": {
          url: urlBase + "/exampleModels/count",
          method: "GET",
        },
        /**
         * @ngdoc method
         * @name lbServices.ExampleModel#prototype$updateAttributes
         * @methodOf lbServices.ExampleModel
         *
         * @description
         *
